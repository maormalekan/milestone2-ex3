...
/**
 * @brief the function gets a circle and a point, and checks if the point is in the circle.
 * 
 * @param c - circle
 * @param p - point
 * @return the function returns true if the point is in the circle. otherwise, it returns false.
 */
...
/**
 * @brief the function gets vector of points that have to be on the edge of the circle,
 * and returns the minimum circle that include them.
 * 
 ...
 * 
 * @param points - an array points that we want find a minimum enclosing circle for them.
